export const perguntas = [
    {
        enunciado: "Você é um jogador jovem que recebeu propostas de times do exterior, e terá que se mudar",
        alternativas: [
            {
                texto: "Isso é assustador!",
                afirmacao: [
                    "No início ficou com medo ",
                    "Achou assustador conviver com pessoas de outros países."
                ],
                proxima: 1,
            },
            {
